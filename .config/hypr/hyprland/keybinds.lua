...
--# OCR
hl.bind("SUPER + SHIFT + T", hl.dsp.global("quickshell:regionOcr"), {description = "Character recognition >> clipboard"} )
hl.bind("SUPER + SHIFT + X", hl.dsp.global("quickshell:screenTranslate"), {description = "Translate screen content"} )
...
hl.bind("SUPER + Backslash", hl.dsp.exec_cmd("warp-terminal"), {description = "Warp terminal"} )
